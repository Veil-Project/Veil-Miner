...
#
# Testscript to test veilminer multiple pools/hosts/syntaxes
# Put this script in the bin directory of veilminer and start running
#
...
# export some vars as "./veilminer" could be still a wrapper script
...
for pool in $POOLS; do
    ...
    echo "./veilminer -v 1 --exit --report-hashrate -P $pool $@"
    echo "./veilminer -v 1 --exit --report-hashrate -P $pool $@" > log.txt
    ./veilminer -v 1 --exit --report-hashrate -P $pool $@ >> log.txt 2>&1 &
    pid=$!
    #echo "PID=$pid"
