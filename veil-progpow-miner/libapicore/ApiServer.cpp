                ...
                m_message, http_matches, http_pattern, std::regex_constants::match_default))
        {
            ...
            if (http_method != "GET")
            {
                ...
                ss << http_ver << " "
                   ...
                   << "Server: " << veilminer_get_buildinfo()->project_name_with_version << "\r\n"
...
Json::Value ApiConnection::getMinerStat1()
{
    ...
    jRes[0] = veilminer_get_buildinfo()->project_name_with_version;  // miner version.
 ...
 *    https://github.com/gangnamtestnet/veilminer/pull/1232#discussion_r193995891
...
Json::Value ApiConnection::getMinerStatDetail()
{
    ...
    /* Host Info */
    Json::Value hostinfo;
    hostinfo["version"] = veilminer_get_buildinfo()->project_name_with_version;  // miner version.
