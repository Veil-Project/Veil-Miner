# ethash-kernels
For whatever reason, Zawawawa released his Ethash kernels as open source code. This repo is a verbaitm copy of that code with a simplistic build environment and [veilminer](https://github.com/gangnamtestnet/veilminer) as a target. Although the code for veilminer has yet to be released.
